package com.example.myapplication.nicedialog;
...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = (int) (getScreenWidth(getContext()) - 2 * dp2px(margin));
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = (int) dp2px(width);
            }
